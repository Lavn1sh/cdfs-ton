...
$(BIN_DIR)/cdfs_metadata: common/serialization.o metadata_server/metadata.o metadata_server/metadata_server.c
	$(CC) $(CFLAGS) common/serialization.o metadata_server/metadata.o metadata_server/metadata_server.c -o $(BIN_DIR)/cdfs_metadata

storage_node/storage.o: storage_node/storage.c
	$(CC) $(CFLAGS) -c storage_node/storage.c -o storage_node/storage.o

$(BIN_DIR)/cdfs_storage: common/serialization.o storage_node/storage.o storage_node/storage_node.c
	$(CC) $(CFLAGS) common/serialization.o storage_node/storage.o storage_node/storage_node.c -o $(BIN_DIR)/cdfs_storage

$(BIN_DIR)/cdfs_client: common/serialization.o client/dfs_client.c main.c
	$(CC) $(CFLAGS) common/serialization.o client/dfs_client.c main.c -o $(BIN_DIR)/cdfs_client
